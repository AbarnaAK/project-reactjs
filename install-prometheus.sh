...
sudo cp prometheus-2.23.0.linux-amd64/promtool /usr/local/bin  # Fixed this line
...
sudo cp prometheus-2.23.0.linux-amd64/promtool /usr/local/bin/  # Removed the redundant line
